...
void menuCrearTransaccionDB(Inventario* inv, sqlite3* db) {
    ...
    if (!trans) {
        printf("\033[1;31mError al crear la transacción.\033[0m\n");
        return;
    }
    ...
    printf("\n\033[1;35m");
    printf("+--------------------------------------+\n");
    printf("|         CREAR TRANSACCIÓN            |\n");
    printf("+--------------------------------------+\n");
    printf("\033[0m");
    printf("Seleccione el tipo de transacción:\n");
    printf("1. Venta\n");
    printf("2. Compra\n");
    ...
    while (continuar) {
        ...
        printf("\n\033[1;35m");
        printf("+--------------------------------------+\n");
        printf("|    AGREGAR ÍTEM A LA TRANSACCIÓN     |\n");
        printf("+--------------------------------------+\n");
        printf("\033[0m");
        ...
        if (!prod) {
            ...
            if (agregarItemTransaccion(trans, *prod, cantidad) == 0)
                printf("\n \033[1;32mÍtem agregado exitosamente.\033[0m\n");
            else
                printf("\n \033[1;31mError al agregar el ítem.\033[0m\n");
        }
    ...
    if (guardarTransaccionDB(db, trans) == 0)
        printf("\n \033[1;32mTransacción guardada exitosamente.\033[0m\n");
    else
        printf("\n \033[1;31mError al guardar la transacción.\033[0m\n");
